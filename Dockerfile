...
RUN apt-get update && export DEBIAN_FRONTEND=noninteractive \
    && apt-get -y install --no-install-recommends php7.4 php7.4-bcmath php7.4-bz2 php7.4-intl php7.4-gd php7.4-mbstring php7.4-mysql php7.4-zip php7.4-dom php7.4-yaml php7.4-curl mariadb-server apache2
...
# Copy over app and setup apache.
# COPY /local-dev-files/000-default.conf /etc/apache2/sites-available/000-default.conf
# Removing: chown -R www-data:www-data /workspaces/drupal-codespaces-template && \ from below
